    ...
    <div class="col-12 mb-4">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <a href="{{ route('retailer.orders', ['status' => 'all']) }}">
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <a href="{{ route('retailer.orders', ['status' => 'pending']) }}">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <a href="{{ route('retailer.orders', ['status' => 'completed']) }}">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
...
<div class="col-md-6 mb-4">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('retailer.orders') }}" class="btn btn-outline-primary">
                        <i class="ri-list-check me-2"></i>View Outgoing
                    </a>
        </div>
        <div class="card-body">
