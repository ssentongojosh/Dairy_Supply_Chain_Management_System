...
@endif 
    <body>
        ...
        <form action="{{ route('raw-inventory.search') }}" method="GET" style="margin-bottom:20px;">
        ...
        <form id ="createForm" action="{{ route ('raw-inventory.store') }}" method="POST" class="inline-form">
            @csrf
            <label>Name: </label>
            ...
            <tbody>
             ...
             @forelse ($inventory as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('raw-inventory.search', ['search' => $item->name]) }}"><button type="button">Edit</button></a> |
