...
@section('title', 'Plantmanager Dashboard')
    ...
    <div class="col-md-8 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('plantmanager.inventory') }}" class="btn btn-primary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('plantmanager.orders') }}" class="btn btn-outline-primary">
                        <i class="ri-list-check me-2"></i>View Orders
                    </a>
                    <a href="{{ route('plantmanager.inventory') }}" class="btn btn-outline-info">
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('plantmanager.orders.history') }}" class="btn btn-outline-primary btn-sm">
