...
<div class="container-fluid">
    <h4 class="fw-bold py-3 mb-4">Plantmanager Dashboard</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h5 class="card-header">Place Order to supplier</h5>
                <div class="card-body">
                    <form action="{{ route('plantmanager.orders.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
