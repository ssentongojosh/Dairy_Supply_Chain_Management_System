    ...
    <div class="card">
        ...
        <div class="card-body">
            @if ($payment && $payment->amount > 0)
                <p><strong>Amount:</strong> UGX {{ number_format($payment->amount, 0) }}</p>
                <p><strong>Method:</strong> {{ strtoupper($payment->method) }}</p>
            @else
                <p><strong>Amount:</strong> UGX {{ number_format($order->total_amount, 0) }}</p>
                <p><strong>Method:</strong> Not specified</p>
            @endif
