...
@section('title', 'Order History - Supplier')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if(request()->hasAny(['status', 'date_from', 'date_to', 'search']))
                            <div class="mb-3">
                                <a href="{{ route('supplier.orders.history') }}" class="btn btn-outline-secondary btn-sm">
                    ...
                    <div class="card-body border-top">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ route('supplier.orders.show', $order) }}" class="fw-semibold text-primary">
                                                    #{{ $order->id }}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('supplier.orders.show', $order) }}?print=true" target="_blank">
                                                            <i class="ri-printer-line me-2"></i>Print Invoice
                                                        </a>
                                                        <a class="dropdown-item" href="{{ route('supplier.orders.show', $order) }}?download=true">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                @if(request()->hasAny(['status', 'date_from', 'date_to', 'search']))
                                    <a href="{{ route('supplier.orders.history') }}" class="btn btn-outline-primary">
