{{-- filepath: c:\xampp\htdocs\DSCMS\resources\views\supplier\dashboard.blade.php --}}
      ...
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="salesChart">
            <a class="dropdown-item" href="{{ route('supplier.orders.history') }}">View All Orders</a>
  ...
  <div class="col-lg-4 col-12 mb-4">
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <div class="mt-3">
          <a href="{{ route('supplier.inventory') }}" class="btn btn-warning btn-sm w-100">
  ...
  <div class="col-lg-8 col-12 mb-4">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('supplier.orders') }}" class="btn btn-primary btn-sm">View All</a>
      </div>
      <div class="card-body">
  ...
  <div class="col-12 mb-4">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('supplier.inventory') }}" class="btn btn-warning btn-sm">Manage Inventory</a>
      </div>
      <div class="card-body">
        <div class="row">
