...
@section('title', 'Order Details - Supplier')
                    ...
                    <div class="card-body">
                        ...
                        <div class="dropdown w-100">
                            ...
                            <ul class="dropdown-menu w-100">
                                <li><a class="dropdown-item" href="{{ route('supplier.orders.show', $order) }}?print=true" target="_blank">
                                    <i class="ri-printer-line me-2"></i>Print Order
                                </a></li>
                                <li><a class="dropdown-item" href="{{ route('supplier.orders.show', $order) }}?download=true">
                                    <i class="ri-download-line me-2"></i>Download PDF
                                </a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="{{ route('supplier.orders.history') }}">
